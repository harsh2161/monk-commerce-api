...
public class ExternalAPI
{
    ...
    public static final String GET_PRODUCTS = "https://stageapi.monkcommerce.app/task/products";
    ...
    public static String getProductWithParams(Integer limit, Integer page,String categoryId)
    {
        return GET_PRODUCTS + "?limit="+limit+"&page="+page+"&categoryID="+categoryId;
    }
}
