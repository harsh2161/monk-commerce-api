...
public class CategoriesRepository
{
    ...
    public CategoriesDTO getCategories(CategoryRequest request)
    {
        try {
            ...
            ApiFuture<QuerySnapshot> getCategories = baseCollection.document("Categories").collection("product-category").orderBy("noOfProducts", Query.Direction.DESCENDING).limit(request.getLimit()).offset(request.getPage()*request.getLimit()).get();
